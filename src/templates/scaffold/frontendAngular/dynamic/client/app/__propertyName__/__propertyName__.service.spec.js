...
describe('Service: ${domainClass.shortName}Service', function () {
  ...
  it('query() should respond', function () {
  	...
  	httpBackend.whenGET(config.restUrl + '/${domainClass.propertyName.toLowerCase()}s/v1').respond([{"id":1},{"id":2}]);
  ...
  it('get() should respond', function () {
  	httpBackend.whenGET('l10n/en.js').respond();
  	httpBackend.whenGET(config.restUrl + '/${domainClass.propertyName.toLowerCase()}s/v1/1').respond({"id":1});
  ...
  it('update() should respond', function () {
  	httpBackend.whenGET('l10n/en.js').respond();
  	httpBackend.whenPUT(config.restUrl + '/${domainClass.propertyName.toLowerCase()}s/v1/1').respond({"id":1});
  ...
  it('save() should respond', function () {
  	httpBackend.whenGET('l10n/en.js').respond();
  	httpBackend.whenPOST(config.restUrl + '/${domainClass.propertyName.toLowerCase()}s/v1').respond({"id":1});
